// Command protoc-gen-plateau-authn translates Plateau AuthN annotations into
// authn_rules.gen.go files consumed by Plateau AuthN runtime.
package main
...
func writeFile(g *protogen.GeneratedFile, packageName protogen.GoPackageName, rules []ruleplan.Entry[*authnpb.AuthnRule]) {
	authnPackage := protogen.GoImportPath("github.com/Servora-Kit/plateau/api/gen/go/plateau/security/authn/v1")
	protoPackage := protogen.GoImportPath("google.golang.org/protobuf/proto")

	g.P("// Code generated by protoc-gen-plateau-authn. DO NOT EDIT.")
	g.P()
	...
	g.P("// AuthnRules returns the authentication rules declared via Plateau AuthN annotations.")
