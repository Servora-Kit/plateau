...
const (
	SessionService_Logout_FullMethodName = "/iam.session.v1.SessionService/Logout"
)
...
var SessionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "iam.session.v1.SessionService",
	...
	Metadata: "iam/session/v1/session.proto",
}
