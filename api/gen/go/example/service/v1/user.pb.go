...
func (UserErrorReason) Descriptor() protoreflect.EnumDescriptor {
	return file_example_service_v1_user_proto_enumTypes[0].Descriptor()
}

func (UserErrorReason) Type() protoreflect.EnumType {
	return &file_example_service_v1_user_proto_enumTypes[0]
}
...
func (UserErrorReason) EnumDescriptor() ([]byte, []int) {
	return file_example_service_v1_user_proto_rawDescGZIP(), []int{0}
}
...
func (x *User) Reset() {
	*x = User{}
	mi := &file_example_service_v1_user_proto_msgTypes[0]
...
func (x *GetUserRequest) Reset() {
	*x = GetUserRequest{}
	mi := &file_example_service_v1_user_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetUserRequest) Descriptor() ([]byte, []int) {
	return file_example_service_v1_user_proto_rawDescGZIP(), []int{1}
}
...
func (x *ListUsersRequest) Reset() {
	*x = ListUsersRequest{}
	mi := &file_example_service_v1_user_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListUsersRequest) Descriptor() ([]byte, []int) {
	return file_example_service_v1_user_proto_rawDescGZIP(), []int{2}
}
...
func (x *ListUsersResponse) Reset() {
	*x = ListUsersResponse{}
	mi := &file_example_service_v1_user_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListUsersResponse) Descriptor() ([]byte, []int) {
	return file_example_service_v1_user_proto_rawDescGZIP(), []int{3}
}
...
func (x *CreateUserRequest) Reset() {
	*x = CreateUserRequest{}
	mi := &file_example_service_v1_user_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateUserRequest) Descriptor() ([]byte, []int) {
	return file_example_service_v1_user_proto_rawDescGZIP(), []int{4}
}
...
func (x *UpdateUserRequest) Reset() {
	*x = UpdateUserRequest{}
	mi := &file_example_service_v1_user_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateUserRequest) Descriptor() ([]byte, []int) {
	return file_example_service_v1_user_proto_rawDescGZIP(), []int{5}
}
...
func (x *DeleteUserRequest) Reset() {
	*x = DeleteUserRequest{}
	mi := &file_example_service_v1_user_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeleteUserRequest) Descriptor() ([]byte, []int) {
	return file_example_service_v1_user_proto_rawDescGZIP(), []int{6}
}
...
func (x *UndeleteUserRequest) Reset() {
	*x = UndeleteUserRequest{}
	mi := &file_example_service_v1_user_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UndeleteUserRequest) Descriptor() ([]byte, []int) {
	return file_example_service_v1_user_proto_rawDescGZIP(), []int{7}
}
...
const file_example_service_v1_user_proto_rawDesc = "" +
	...
	"\x05users\x18\x01 \x03(\v2\x18.example.service.v1.UserR\x05users\x12&\n" +
	...
	"\x04user\x18\x03 \x01(\v2\x18.example.service.v1.UserB\x03\xe0A\x02R\x04user\"\xb2\x01\n" +
	"\x11UpdateUserRequest\x121\n" +
	"\x04user\x18\x01 \x01(\v2\x18.example.service.v1.UserB\x03\xe0A\x02R\x04user\x12@\n" +
	...
	"\x04name\x18\x01 \x01(\tB \xe0A\x02\xfaA\x1a\n" +
	"\x18example.servora.dev/UserR\x04name*\xbc\x01\n" +
	...
	"\fUndeleteUser\x12'.example.service.v1.UndeleteUserRequest\x1a\x18.example.service.v1.User\"\a\xdaA\x04nameB\xe1\x01\n" +
	"\x16com.example.service.v1B\tUserProtoP\x01ZRgithub.com/Servora-Kit/servora-platform/api/gen/go/example/service/v1;examplesvcpb\xa2\x02\x03ESX\xaa\x02\x12Example.Service.V1\xca\x02\x12Example\\Service\\V1\xe2\x02\x1eExample\\Service\\V1\\GPBMetadata\xea\x02\x14Example::Service::V1b\x06proto3"

var (
	file_example_service_v1_user_proto_rawDescOnce sync.Once
	file_example_service_v1_user_proto_rawDescData []byte
)

func file_example_service_v1_user_proto_rawDescGZIP() []byte {
	file_example_service_v1_user_proto_rawDescOnce.Do(func() {
		file_example_service_v1_user_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_example_service_v1_user_proto_rawDesc), len(file_example_service_v1_user_proto_rawDesc)))
	})
	return file_example_service_v1_user_proto_rawDescData
}

var file_example_service_v1_user_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_example_service_v1_user_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_example_service_v1_user_proto_goTypes = []any{
	(UserErrorReason)(0),          // 0: example.service.v1.UserErrorReason
	(*User)(nil),                  // 1: example.service.v1.User
	(*GetUserRequest)(nil),        // 2: example.service.v1.GetUserRequest
	(*ListUsersRequest)(nil),      // 3: example.service.v1.ListUsersRequest
	(*ListUsersResponse)(nil),     // 4: example.service.v1.ListUsersResponse
	(*CreateUserRequest)(nil),     // 5: example.service.v1.CreateUserRequest
	(*UpdateUserRequest)(nil),     // 6: example.service.v1.UpdateUserRequest
	(*DeleteUserRequest)(nil),     // 7: example.service.v1.DeleteUserRequest
	(*UndeleteUserRequest)(nil),   // 8: example.service.v1.UndeleteUserRequest
	(*timestamppb.Timestamp)(nil), // 9: google.protobuf.Timestamp
	(*fieldmaskpb.FieldMask)(nil), // 10: google.protobuf.FieldMask
}
var file_example_service_v1_user_proto_depIdxs = []int32{
	9,  // 0: example.service.v1.User.create_time:type_name -> google.protobuf.Timestamp
	9,  // 1: example.service.v1.User.update_time:type_name -> google.protobuf.Timestamp
	9,  // 2: example.service.v1.User.delete_time:type_name -> google.protobuf.Timestamp
	9,  // 3: example.service.v1.User.purge_time:type_name -> google.protobuf.Timestamp
	1,  // 4: example.service.v1.ListUsersResponse.users:type_name -> example.service.v1.User
	1,  // 5: example.service.v1.CreateUserRequest.user:type_name -> example.service.v1.User
	1,  // 6: example.service.v1.UpdateUserRequest.user:type_name -> example.service.v1.User
	10, // 7: example.service.v1.UpdateUserRequest.update_mask:type_name -> google.protobuf.FieldMask
	2,  // 8: example.service.v1.UserService.GetUser:input_type -> example.service.v1.GetUserRequest
	3,  // 9: example.service.v1.UserService.ListUsers:input_type -> example.service.v1.ListUsersRequest
	5,  // 10: example.service.v1.UserService.CreateUser:input_type -> example.service.v1.CreateUserRequest
	6,  // 11: example.service.v1.UserService.UpdateUser:input_type -> example.service.v1.UpdateUserRequest
	7,  // 12: example.service.v1.UserService.DeleteUser:input_type -> example.service.v1.DeleteUserRequest
	8,  // 13: example.service.v1.UserService.UndeleteUser:input_type -> example.service.v1.UndeleteUserRequest
	1,  // 14: example.service.v1.UserService.GetUser:output_type -> example.service.v1.User
	4,  // 15: example.service.v1.UserService.ListUsers:output_type -> example.service.v1.ListUsersResponse
	1,  // 16: example.service.v1.UserService.CreateUser:output_type -> example.service.v1.User
	1,  // 17: example.service.v1.UserService.UpdateUser:output_type -> example.service.v1.User
	1,  // 18: example.service.v1.UserService.DeleteUser:output_type -> example.service.v1.User
	1,  // 19: example.service.v1.UserService.UndeleteUser:output_type -> example.service.v1.User
...
func init() { file_example_service_v1_user_proto_init() }
func file_example_service_v1_user_proto_init() {
	if File_example_service_v1_user_proto != nil {
		return
	}
	file_example_service_v1_user_proto_msgTypes[0].OneofWrappers = []any{}
	file_example_service_v1_user_proto_msgTypes[3].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_example_service_v1_user_proto_rawDesc), len(file_example_service_v1_user_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_example_service_v1_user_proto_goTypes,
		DependencyIndexes: file_example_service_v1_user_proto_depIdxs,
		EnumInfos:         file_example_service_v1_user_proto_enumTypes,
		MessageInfos:      file_example_service_v1_user_proto_msgTypes,
	}.Build()
	File_example_service_v1_user_proto = out.File
	file_example_service_v1_user_proto_goTypes = nil
	file_example_service_v1_user_proto_depIdxs = nil
}
