...
var (
	...
	file_platform_security_jwt_v1_config_proto_rawDescData []byte
)

func file_platform_security_jwt_v1_config_proto_rawDescGZIP() []byte {
	file_platform_security_jwt_v1_config_proto_rawDescOnce.Do(func() {
		file_platform_security_jwt_v1_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_platform_security_jwt_v1_config_proto_rawDesc), len(file_platform_security_jwt_v1_config_proto_rawDesc)))
	})
	return file_platform_security_jwt_v1_config_proto_rawDescData
}
...
func init() { file_platform_security_jwt_v1_config_proto_init() }
func file_platform_security_jwt_v1_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_platform_security_jwt_v1_config_proto_rawDesc), len(file_platform_security_jwt_v1_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_platform_security_jwt_v1_config_proto_goTypes,
		DependencyIndexes: file_platform_security_jwt_v1_config_proto_depIdxs,
		MessageInfos:      file_platform_security_jwt_v1_config_proto_msgTypes,
	}.Build()
	File_platform_security_jwt_v1_config_proto = out.File
	file_platform_security_jwt_v1_config_proto_goTypes = nil
	file_platform_security_jwt_v1_config_proto_depIdxs = nil
}
