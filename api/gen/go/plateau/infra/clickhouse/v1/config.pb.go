...
func (x *ClickHouse) Reset() {
	*x = ClickHouse{}
	mi := &file_plateau_infra_clickhouse_v1_config_proto_msgTypes[0]
...
func (*ClickHouse) Descriptor() ([]byte, []int) {
	return file_plateau_infra_clickhouse_v1_config_proto_rawDescGZIP(), []int{0}
}
...
var File_plateau_infra_clickhouse_v1_config_proto protoreflect.FileDescriptor
...
var (
	...
	file_plateau_infra_clickhouse_v1_config_proto_rawDescData []byte
)

func file_plateau_infra_clickhouse_v1_config_proto_rawDescGZIP() []byte {
	file_plateau_infra_clickhouse_v1_config_proto_rawDescOnce.Do(func() {
		file_plateau_infra_clickhouse_v1_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_plateau_infra_clickhouse_v1_config_proto_rawDesc), len(file_plateau_infra_clickhouse_v1_config_proto_rawDesc)))
	})
	return file_plateau_infra_clickhouse_v1_config_proto_rawDescData
}

var file_plateau_infra_clickhouse_v1_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_plateau_infra_clickhouse_v1_config_proto_goTypes = []any{
	(*ClickHouse)(nil),          // 0: plateau.infra.clickhouse.v1.ClickHouse
	(*durationpb.Duration)(nil), // 1: google.protobuf.Duration
	(*v1.TLS)(nil),              // 2: servora.security.tls.v1.TLS
}
var file_plateau_infra_clickhouse_v1_config_proto_depIdxs = []int32{
	1, // 0: plateau.infra.clickhouse.v1.ClickHouse.dial_timeout:type_name -> google.protobuf.Duration
	1, // 1: plateau.infra.clickhouse.v1.ClickHouse.read_timeout:type_name -> google.protobuf.Duration
	1, // 2: plateau.infra.clickhouse.v1.ClickHouse.conn_max_lifetime:type_name -> google.protobuf.Duration
	2, // 3: plateau.infra.clickhouse.v1.ClickHouse.tls:type_name -> servora.security.tls.v1.TLS
...
func init() { file_plateau_infra_clickhouse_v1_config_proto_init() }
func file_plateau_infra_clickhouse_v1_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_plateau_infra_clickhouse_v1_config_proto_rawDesc), len(file_plateau_infra_clickhouse_v1_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_plateau_infra_clickhouse_v1_config_proto_goTypes,
		DependencyIndexes: file_plateau_infra_clickhouse_v1_config_proto_depIdxs,
		MessageInfos:      file_plateau_infra_clickhouse_v1_config_proto_msgTypes,
	}.Build()
	File_plateau_infra_clickhouse_v1_config_proto = out.File
	file_plateau_infra_clickhouse_v1_config_proto_goTypes = nil
	file_plateau_infra_clickhouse_v1_config_proto_depIdxs = nil
}
