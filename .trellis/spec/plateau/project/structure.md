...
- `api/`：平台领域 Proto 与共享生成产物。
  ...
  - `gen/package.json`：`@plateau/api` 的依赖及 exports；`gen/go.mod`：独立生成模块。
...
- `go.work`：连接 Plateau 根模块、平台生成模块、三个微服务，以及相邻 Servora 和其生成模块；各 `go.mod`／`go.sum` 管理所属模块依赖。
...
来源：[根 AGENTS](../../../../AGENTS.md)、[API 约定](../../../../api/AGENTS.md)、[go.work](../../../../go.work)、[pnpm workspace](../../../../pnpm-workspace.yaml)、[API exports](../../../../api/gen/package.json)。
