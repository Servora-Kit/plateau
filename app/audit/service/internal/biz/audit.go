...
type AuditRepo interface {
	ListEvents(ctx context.Context, req *auditpb.ListAuditEventsRequest) ([]*auditpb.AuditEventItem, string, error)
	CountEvents(ctx context.Context, req *auditpb.CountAuditEventsRequest) (int64, error)
}
...
func (uc *AuditUsecase) ListEvents(ctx context.Context, req *auditpb.ListAuditEventsRequest) ([]*auditpb.AuditEventItem, string, error) {
	return uc.repo.ListEvents(ctx, req)
}

// CountEvents delegates to the repository.
func (uc *AuditUsecase) CountEvents(ctx context.Context, req *auditpb.CountAuditEventsRequest) (int64, error) {
