...
//		GroupBy(oauthaccesstoken.FieldTokenSessionID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.OAuthAccessToken.Query().
//		Select(oauthaccesstoken.FieldTokenSessionID).
//		Scan(ctx, &v)
...
func (_q *OAuthAccessTokenQuery) Modify(modifiers ...func(s *sql.Selector)) *OAuthAccessTokenSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *OAuthAccessTokenSelect) Modify(modifiers ...func(s *sql.Selector)) *OAuthAccessTokenSelect {
