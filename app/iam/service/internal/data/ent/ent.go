...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			oauthtokensession.Table:        oauthtokensession.ValidColumn,
			oidcauthorizationrequest.Table: oidcauthorizationrequest.ValidColumn,
			oidcsigningkey.Table:           oidcsigningkey.ValidColumn,
			passwordauthenticator.Table:    passwordauthenticator.ValidColumn,
