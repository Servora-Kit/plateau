...
当前应用规范见 [Example](../../../.trellis/spec/example/index.md)，其中 [frontend](../../../.trellis/spec/example/frontend.md)、[requests](../../../.trellis/spec/example/requests.md) 和 [forms](../../../.trellis/spec/example/forms.md) 分别维护前端组织、请求合同与交互要求。
