...
func (m *UserMutation) SetPurgeTime(t time.Time) {
	m.purge_time = &t
}

// PurgeTime returns the value of the "purge_time" field in the mutation.
func (m *UserMutation) PurgeTime() (r time.Time, exists bool) {
	v := m.purge_time
	if v == nil {
		return
	}
...
// OldPurgeTime returns the old "purge_time" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldPurgeTime(ctx context.Context) (v *time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *UserMutation) ClearPurgeTime() {
	m.purge_time = nil
	m.clearedFields[user.FieldPurgeTime] = struct{}{}
}

// PurgeTimeCleared returns if the "purge_time" field was cleared in this mutation.
func (m *UserMutation) PurgeTimeCleared() bool {
	_, ok := m.clearedFields[user.FieldPurgeTime]
	return ok
}

// ResetPurgeTime resets all changes to the "purge_time" field.
func (m *UserMutation) ResetPurgeTime() {
	m.purge_time = nil
	delete(m.clearedFields, user.FieldPurgeTime)
}
...
func (m *UserMutation) SetResourceID(s string) {
	m.resource_id = &s
}

// ResourceID returns the value of the "resource_id" field in the mutation.
func (m *UserMutation) ResourceID() (r string, exists bool) {
	v := m.resource_id
	if v == nil {
		return
	}
...
// OldResourceID returns the old "resource_id" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldResourceID(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *UserMutation) ResetResourceID() {
	m.resource_id = nil
}
...
func (m *UserMutation) SetTenantPlan(s string) {
	m.tenant_plan = &s
}

// TenantPlan returns the value of the "tenant_plan" field in the mutation.
func (m *UserMutation) TenantPlan() (r string, exists bool) {
	v := m.tenant_plan
	if v == nil {
		return
	}
...
// OldTenantPlan returns the old "tenant_plan" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldTenantPlan(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldTenantPlan is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldTenantPlan requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldTenantPlan: %w", err)
	}
	return oldValue.TenantPlan, nil
}

// ResetTenantPlan resets all changes to the "tenant_plan" field.
func (m *UserMutation) ResetTenantPlan() {
	m.tenant_plan = nil
}
...
func (m *UserMutation) Fields() []string {
	...
	if m.purge_time != nil {
		fields = append(fields, user.FieldPurgeTime)
	}
	if m.tenant_id != nil {
		fields = append(fields, user.FieldTenantID)
	}
	if m.resource_id != nil {
		fields = append(fields, user.FieldResourceID)
	}
	...
	if m.tenant_plan != nil {
		fields = append(fields, user.FieldTenantPlan)
	}
	if m.nickname != nil {
...
func (m *UserMutation) ClearedFields() []string {
	...
	if m.FieldCleared(user.FieldPurgeTime) {
		fields = append(fields, user.FieldPurgeTime)
	}
