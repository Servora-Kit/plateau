...
- 公共包归属：`security/authn`、`security/authz`、`security/jwt`、`security/rebac/openfga`、`infra/openfga`。
- 安全 Proto 位于 `api/protos/platform/**`；AuthN/AuthZ 插件从当前 checkout 的 `cmd/` 本地安装。
